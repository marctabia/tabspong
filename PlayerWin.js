TabsPong.PlayerWin = function(game) {
    this.winText = null;
    this.overBg = null;
};

TabsPong.PlayerWin.prototype = {
    ...
    create : function() {
        ...
        this.winText = this.add.bitmapText(this.world.centerX, this.world.centerY - 100, 'eightbitwonder', 'Player Wins!!!', 32);
